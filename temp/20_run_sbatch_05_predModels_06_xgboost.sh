#!/bin/bash
#SBATCH --job-name=predModel_xgboost       # Name of job
#SBATCH --output=scripts/predModel_xgboost.out        # stdout
#SBATCH --error=scripts/predModel_xgboost.err         # stderr
...
Rscript scripts/16_predModels_06_xgboost.R
