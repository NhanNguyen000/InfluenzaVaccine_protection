...
# save the result
save(res.elasticModel_2groups_equalRatio_splitCohort, file = "20230404_res.elasticModel_2groups_equalRatio_splitCohort.RData")
...
# save the result
save(res.elasticModel_2groups_1to2Ratio_splitCohort, file = "20230404_res.elasticModel_2groups_1to2Ratio_splitCohort.RData")
