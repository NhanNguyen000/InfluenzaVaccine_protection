...
get.elasticModel <- function(train_inputSet, train_predOut, 
  ...
  for (i in 1:n) {
    ...
    res_preVal[[i]] <- confusionMatrix(val.pred, validation_predOut) # Training accuracy
...
# # save the result
# save(res.elasticModel_4groups , file = "20230503_res.elasticModel_4groups.RData")
...
# save the result
save(res.elasticModel_2groups_equalRatio , file = "20230503_res.elasticModel_2groups_equalRatio.RData")
...
# save the result
save(res.elasticModel_2groups_1to2Ratio, file = "202304503_res.elasticModel_2groups_1to2Ratio.RData")
