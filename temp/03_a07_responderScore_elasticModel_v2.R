...
# save the result
save(res.elasticModel_4groups , file = "20230424_res.elasticModel_4groups.RData")
...
# save the result
save(res.elasticModel_2groups_equalRatio , file = "20230424_res.elasticModel_2groups_equalRatio.RData")
...
# save the result
save(res.elasticModel_2groups_1to2Ratio, file = "20230424_res.elasticModel_2groups_1to2Ratio.RData")
