#!/bin/bash
#SBATCH --job-name=predModels       # Name of job
#SBATCH --output=scripts/predModels.out        # stdout
#SBATCH --error=scripts/predModels.err         # stderr
...
Rscript scripts/16_predModels_01_reclassify.R
