#!/bin/bash
#SBATCH --job-name=predModel_nnet       # Name of job
#SBATCH --output=scripts/predModel_glmnet.out        # stdout
#SBATCH --error=scripts/predModel_glmnet.err         # stderr
...
Rscript scripts/16_predModels_07_glmnet.R
