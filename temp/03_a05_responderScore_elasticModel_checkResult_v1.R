load("20230328_res.elasticModel_4groups.RData")
load("20230328_res.elasticModel_2groups_equalRatio.RData")
load("20230328_res.elasticModel_2groups_1to2Ratio.RData")

load("20230404_res.elasticModel_2groups_equalRatio_splitCohort.RData")
load("20230404_res.elasticModel_2groups_1to2Ratio_splitCohort.RData")
