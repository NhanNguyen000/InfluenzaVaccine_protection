...
png('/vol/projects/CIIM/Influenza/ZirrFlu/InfluenzaCohorts_NhanNguyen/output/qtl/b_manhattan.png', width = 8, height = 3, units = 'in', res=300)
...
png('/vol/projects/CIIM/Influenza/ZirrFlu/InfluenzaCohorts_NhanNguyen/output/qtl/h1n1_manhattan.png', width = 8, height = 3, units = 'in', res=300)
ggman(df, sparsify = T, significance=NA) +
...
png('/vol/projects/CIIM/Influenza/ZirrFlu/InfluenzaCohorts_NhanNguyen/output/qtl/h3n2_manhattan.png', width = 8, height = 3, units = 'in', res=300)
ggman(df, sparsify = T, significance=NA) +
  labs(title = 'Post-vaccination H1N1 titers') +
  theme_classic() +
  theme(plot.title = element_text(hjust = .5), legend.position = 'none') +
