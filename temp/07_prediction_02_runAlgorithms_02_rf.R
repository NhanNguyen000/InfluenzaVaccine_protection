...
# # check info: https://stackoverflow.com/questions/57939453/building-a-randomforest-with-caret
# # combine results:
...
# save the result -----------------------
save(netFits, netFit_pred, file = "processedDat/prediction_res_rf.RData")
