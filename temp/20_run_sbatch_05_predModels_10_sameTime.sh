#!/bin/bash
#SBATCH --job-name=predModel_sameTime      # Name of job
#SBATCH --output=scripts/predModel_sameTime.out        # stdout
#SBATCH --error=scripts/predModel_sameTime.err         # stderr
...
Rscript scripts/16_predModels_10_sameTimepoint_rf.R
