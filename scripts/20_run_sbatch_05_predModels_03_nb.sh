#!/bin/bash
#SBATCH --job-name=predModel_nb       # Name of job
#SBATCH --output=scripts/predModel_nb.out        # stdout
#SBATCH --error=scripts/predModel_nb.err         # stderr
...
Rscript scripts/16_predModels_03_nb.R
