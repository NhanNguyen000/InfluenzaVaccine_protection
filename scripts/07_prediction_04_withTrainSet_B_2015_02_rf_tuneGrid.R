...
## input variable ----------------------------------------------------------------
load("processedDat/predictInput_BtrainSet.RData")
...
# save the result -----------------------
save(predictModel, predictOutcome, predict_ROC, file = "processedDat/predictOutput_BtrainSet_rf_tuneGrid.RData")
