#!/bin/bash
#SBATCH --job-name=predModel_smv       # Name of job
#SBATCH --output=scripts/predModel_smv.out        # stdout
#SBATCH --error=scripts/predModel_smv.err         # stderr
...
Rscript scripts/16_predModels_02_smv.R
